		...
		if (isAdvanced) {
			try {
				try {
					...
					leader1.setToolTipText("<html><body><div><img style='width: 30%; height: auto;' src=\"file:src/images/Lorenzo_Leaders_compressed/" + playerData.getLeaders()[0].getName().replaceAll(" ", "") + ".jpg\"></div></body></html>");
					...
					leader2.setToolTipText("<html><body><div><img src=\"file:src/images/Lorenzo_Leaders_compressed/" + playerData.getLeaders()[1].getName().replaceAll(" ", "") + ".jpg\"></div></body></html>");
					...
					leader3.setToolTipText("<html><body><div><img src=\"file:src/images/Lorenzo_Leaders_compressed/" + playerData.getLeaders()[2].getName().replaceAll(" ", "") + ".jpg\"></div></body></html>");
					...
					leader4.setToolTipText("<html><body><div><img src=\"file:src/images/Lorenzo_Leaders_compressed/" + playerData.getLeaders()[3].getName().replaceAll(" ", "") + ".jpg\"></div></body></html>");
